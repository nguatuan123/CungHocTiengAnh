...
<body style="background: #F0F0F0">
  ...
  <nav class="container-fuild bg-white navigation-top">
    <div class="container pt-5">
      ...
      <br>
      <br>
      <h2 class="font-weight-bold float-left"><?php
        echo $term_name;
        $check = true;
          if ( isset($_SESSION['username']) ) {
  ...
  <nav class="container-fluid">
    <div class="container">
      <a href="../flash-card/?id=<?php echo $id ?>">
        <div class="items pointer float-left">
      ...
      <a href="../question-game/?id=<?php echo $id ?>">
        <div class="items pointer float-left ml-3" style="border-bottom: solid #FFCD1F 4px !important;transform: translateY(-63px)">
          ...
          <p class="text-center text-primary font-weight-bold">Trò chơi từ vựng</p>
        </div>
      </a>
    </div> 
  </nav>
  ...
  <nav class="container">
    <div class="wecome-form bg-gradient-primary mb-5">
      <h2 class="text-white text-center wellcome-text" id="start">Start test</h2>
    </div>
  </nav>

  <div class="main-container" id="game-content">
    <div class="success-component bg-gradient-primary">
      <div class="shadow">
        <h2 class="font-weight-bold text-white text-center">Hoàn thành <br>
          <span class="text-info">&nbsp;s</span>
          <span class="text-danger">c</span>
          <span class="text-primary">o r</span>
          <span class="text-success">e &nbsp;</span>
          <br>
          <span class="text-white font-weigth-bold" id="success">0</span>
          <span>&nbsp;</span>
          <br>
        </h2>
      </div>
    ...
    <h3 class="float-left text-white ml-5 mt-5 pl-1 rounded bg-white">
      <span class="text-info">&nbsp;s</span>
      <span class="text-danger">c</span>
      <span class="text-default">o r</span>
      <span class="text-success">e &nbsp;</span>
      <span class="text-dark font-weigth-bold" style="margin-top: .1em;" id="score">0</span><span>&nbsp;</span>
    </h3>

    <h1 class="float-right text-white mr-5 mt-5 pl-1 rounded bg-white">
      <span class="text-info">&nbsp;t</span>
      <span class="text-danger">i</span>
      <span class="text-default">m</span>
      <span class="text-success">e &nbsp;</span>
      <span class="text-dark font-weigth-bold" style="margin-top: .1em;" id="time"></span><span>&nbsp;</span>
    </h1>

    <section class="container text-center d-none" id="greeting">
      <h1 class="title">
        <span>enter</span>
        <span>the correct</span>
        <span>word</span>
      </h1>
    </section>

    <div class="main-content text-white" style="display: block;">
        <br>
        <br>
        <p class="text-center font-weight-bold question" style="font-size: 48px;">
          <span class="text-white pl-1 pt-1 pb-1">What</span>
          <span class="text-info">is</span>
          <span class="text-danger">this</span>
        </p>
        <br>
        <div id="key-form" class="bg-white pb-2 pl-2 pr-2 rounded shadow">
          <div id="top-left"></div>
          <div id="top-right"></div>
          <div id="bottom-left"></div>
          <div id="bottom-right"></div>
          <p class="text-dark text-center" id="key-word"></p>
        </div>
    </div>
    <h3 class="result font-weight-bold text-white"></h3>
    <h1 class="font-weight-bold text-success correct">Correct</h1>
    <div class="form">
      <p  class="text-center"><input type="text" class="shadow" id="input" placeholder="Text Hear"></p>
    </div>
    <h3 class="text-center text-info" style="font-family: 'Titan One', cursive;">Vocabulary <span id="voca-number">0</span></h3>
